...
1. **MongoDB URI** - Username: `aseshnemal`, Password: `asesh`
   - Exposed in commits: `52e071e`, `b135c13`, `42928495`, and 8 more
   - Location: `src/lib/mongodb.ts` (now fixed)

2. **Firebase API Key** - `REDACTED_FIREBASE_API_KEY`
...
cat > secrets.txt << 'EOF'
REDACTED:REDACTED@cluster.mongodb.net
...
regex:REDACTED:REDACTED@cluster0\.s5idn\.mongodb\.net==>REMOVED_MONGODB_URI
regex:REDACTED_FIREBASE_API_KEY==>REMOVED_FIREBASE_KEY
EOF
