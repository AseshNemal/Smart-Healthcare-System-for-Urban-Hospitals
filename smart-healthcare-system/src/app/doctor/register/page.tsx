...
export default function DoctorRegisterPage() {
  ...
  const handleGoogleRegister = async () => {
    ...
    try {
      ...
      setError("Please complete registration by filling in your specialty below.");
      setFormData(prev => ({ ...prev, email: userEmail, name: userName }));
      setLoading(false);
    } catch (err: any) {
  ...
  return (
    <div className="max-w-md mx-auto space-y-6">
      <div className="text-center">
        ...
        <p className="text-foreground/70 mt-2">Create your doctor account</p>
      </div>
